...
namespace UnityGLTF.Extensions
{
	public static class SchemaExtensions
	{
		...
		public static UnityEngine.Vector2[] TexCoordArrayVAndCopy(UnityEngine.Vector2[] array)
		{
			var returnArray = new UnityEngine.Vector2[array.Length];
        ...
        public static Vector4[] ConvertBlendIndexAndCopy(BoneWeight[] array)
        {
            var returnArray = new Vector4[array.Length];
        ...
        public static Vector4[] ConvertBlendWeightAndCopy(BoneWeight[] array)
        {
            var returnArray = new Vector4[array.Length];
